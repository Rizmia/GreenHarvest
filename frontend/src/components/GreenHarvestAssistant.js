...
import customChatImage from "../images/ChatBotIcon.png";
import userIconImage from "../images/User-Icon.png";
import "../index.css";
import Navbar from "./Navbar";
import Footer from "./Footer";
...
const GreenHarvestAssistant = () => {
  ...
  return (
    <>
      ...
      <Container
        maxWidth="sm"
        className="green-harvest-container"
        style={{
          marginTop: "20px",
          padding: "20px",
          fontFamily: '"Poppins", sans-serif',
      ...
      >
        ...
        {loading && (
          <CircularProgress style={{ alignSelf: "center", marginBottom: "20px" }} />
        )}
        <Box
          className="header-section"
          display="flex"
