      ...
      try {
        ...
        if (cropData) {
          const formattedData = {
            ...
            crop_quantity: cropData.crop_quantity,
            ...
            Fertilizer_Type: cropData.Fertilizer_Type,
            Fertilizer_quantity: cropData.Fertilizer_quantity,
            Water_Requirement: cropData.Water_Requirement,
            Expected_Yield: cropData.Expected_Yield,
            Weather_Conditions: cropData.Weather_Conditions,
          };
