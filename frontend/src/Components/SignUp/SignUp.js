    ...
    <div className="signup-container">
      ...
      <div className="signup-form">
        ...
        <div>
          ...
          />
          {errors.emailExists && (
            <p className="error-message">This email is already in use. Please use another email.</p>
          )}
          <label>Password</label>
          <input
            type="password"
          ...
          />
          {errors.weakPassword && (
            <p className="error-message">Password must be 8+ characters with at least one symbol.</p>
          )}
          <label>Confirm Password</label>
          <input
            type="password"
          ...
          />
          {errors.phoneInvalid && (
            <p className="error-message">Phone number must be exactly 10 digits.</p>
          )}
          <button onClick={handleSubmit}>Register</button>
        </div>
      </div>
